...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val editTextName:EditText=findViewById(R.id.editText1)
        val editTextEmail:EditText=findViewById(R.id.editText2)
    ...
    fun activity2Button_Click(view: View) {
        ...
        else if (editTextAge.text.toString().toDouble()>110)
        {
            val toastDino: Toast =Toast.makeText(applicationContext,"Вы уверены, что это ваш возраст?",Toast.LENGTH_SHORT)
            toastDino.show()
            editTextAge.requestFocus()
        }
